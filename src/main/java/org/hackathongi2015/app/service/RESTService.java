package org.hackathongi2015.app.service;
...
/*
This is the service that does the REST calls. It MUST be an IntentService because
we want the REST calls to be executed in a new thread.
*/
public class RESTService extends IntentService {
  ...
  public static final String EXTRA_HTTP_VERB = "org.udg.pds.simpleapp_android.EXTRA_HTTP_VERB";
  public static final String EXTRA_PARAMS = "org.udg.pds.simpleapp_android.EXTRA_PARAMS";
  public static final String EXTRA_RESULT_RECEIVER = "org.udg.pds.simpleapp_android.EXTRA_RESULT_RECEIVER";

  public static final String REST_RESULT = "org.udg.pds.simpleapp_android.REST_RESULT";

  /*
  VERY IMPORTANT: the HttpClient MUST be static so there is a single object used by all the REST calls.
  This way the client keeps all the cookies between calls.
  */
  private static HttpClient mClient = new DefaultHttpClient();

  public RESTService() {
    super(TAG);
    mClient.getParams().setParameter(ClientPNames.COOKIE_POLICY, CookiePolicy.RFC_2965);

  }

  // This is the common entry point for all the calls to the Service
  @Override
        ...
        case POST: {
          ...
          if (params != null) {
            if (params.containsKey("json")) {
              StringEntity se = new StringEntity(params.getString("json"));
